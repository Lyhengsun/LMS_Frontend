...
const InstructorAssignmentPageComponent = () => {
  ...
  const handleCreateAssignment = () => {
    ...
    const attachedFileName = attachedFile
      ? `assignment_${Date.now()}_${attachedFile.name}`
      : undefined;
  ...
  const handleGradeSubmission = (
    ...
    if (submission && assignment) {
      ...
      addNotification({
        ...
        message: `Your "${assignment.title}" has been graded. Score: ${grade}/${
          assignment.points
        } points (${percentage}%)${feedback ? ". Check your feedback!" : ""}`,
        priority: "high",
      });
    }
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    {assignments.reduce(
                      (acc, a) => acc + getAssignmentSubmissions(a.id).length,
                      0
                    )}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-600">
                    {assignments.reduce(
                      (acc, a) =>
                        acc +
                        getAssignmentSubmissions(a.id).filter(
                        ...
                        {assignment.attachedFile && (
                          <div className="flex items-center space-x-2 mt-2">
                            ...
                            <Button
                              ...
                              variant="ghost"
                              onClick={() =>
                                downloadAssignmentFile(assignment.attachedFile!)
                              }
                            >
