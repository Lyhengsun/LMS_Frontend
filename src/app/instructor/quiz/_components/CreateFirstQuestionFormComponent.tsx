...
import EditFirstQuestionAnswerFormComponent from "./EditFirstQuestionAnswerFormComponent";

const EditFirstQuestionFormComponent = ({
  questionIndex,
  question,
  questions,
  setQuestions,
          ...
          <div className="space-y-2 mt-2">
            {question.questionType == "MULTIPLE_CHOICE" ? (
              question.answers!.map((answer) => (
                <EditFirstQuestionAnswerFormComponent
                  key={answer.id}
                  question={question}
                  answer={answer}
...
export default EditFirstQuestionFormComponent;
